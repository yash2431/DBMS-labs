...
--Display name of customers with branch whose amount is greater than 4000 and account no less than 105 from deposit table.
...
SELECT *, AMOUNT + AMOUNT*(0.1) AS EXTRACOLUMN FROM BORROW
